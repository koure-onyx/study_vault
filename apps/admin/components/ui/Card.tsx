...
export const Card = React.forwardRef<HTMLDivElement, CardProps>(({ className = '', hover = true, ...props }, ref) => (
  <div ref={ref} className={`bg-white rounded-xl shadow-md p-6 border border-gray-100 transition-all duration-200 ${hover ? 'hover:shadow-lg' : ''} ${className}`} {...props} />
));
